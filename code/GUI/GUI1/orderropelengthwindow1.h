#ifndef ORDERROPELENGTHWINDOW1_H
#define ORDERROPELENGTHWINDOW1_H
#include "globals1.h"
#include <QPushButton>
#include <QLineEdit>
#include <QSpinBox>
...
class orderRopeLengthWindow1 : public QWizardPage
{
    Q_OBJECT
...
public:
    ...
    explicit orderRopeLengthWindow1(QWidget *parent = nullptr);

    //! The destructor of the class
    ~orderRopeLengthWindow1();
...
#endif // ORDERROPELENGTHWINDOW1_H
